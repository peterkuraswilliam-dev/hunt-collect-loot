import { Gift, Gauge, Sparkles, Library, Settings, Boxes, Dices } from "lucide-react";
...
export const rewardsModule: AssetOSModule = {
  slug: "rewards",
  name: "Rewards",
  description: "CMS-first source of truth for reward types, library, bundles and loot tables.",
  icon: Gift,
  sections: [
    ...
    { key: "loot", label: "Loot Tables", icon: Dices, component: LootTables },
