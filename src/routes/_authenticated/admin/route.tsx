...
import { Boxes, Coins, Gauge, Layers, Library, Package, ShieldAlert, Sparkles, TrendingUp, Users } from "lucide-react";
...
const TABS = [
  ...
  { to: "/admin/modules/assets", label: "Assets Module", Icon: Layers },
